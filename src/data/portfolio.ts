...
export const projects: Project[] = [
  {
    ...
    description:
      "An enterprise-grade facility reservation platform to streamline operations for the entire RSAF.",
    category: "Enterprise",
    organization: "RAiD",
    tools: ["Microsoft Dataverse", "React", "Gemini 3.1", "Claude Opus 4.6"],
    learningPoints:
